<template>
  <v-container grid-list-xl>
    <v-layout row wrap>
      <v-flex xs12 mb-2>
        <b class="display-1">ลงทะเบียนเจ้าหน้าที่</b>
      </v-flex>
    </v-layout>
    <v-layout row wrap>
      <v-flex xs12>
    ...
    <!-- <v-layout>
      <v-flex xs12 v-if="showRequesttobeEmployee2">
        <RequesttobeEmployee2 />
      </v-flex>
    </v-layout> -->
    <!-- <Permission/> -->
...
// import RequesttobeEmployee2 from '@/pages/hospital/RequesttobeEmployee2'
export default {
  components: {
    Encode,
    Decode
  ...
  watch: {
    ...
    showData () {
      if (this.showData === true) {
        this.showRequesttobeEmployee2 = false
      }
    }
  },
  data () {
    return {
      ...
      itemsSkill: [],
      position: '',
      itemsPosition: ['พนักงานต้อนรับ', 'พนักงานอัปโหลด', 'พนักงานดูแลระบบ']
    }
  },
  methods: {
    submitReg () {
