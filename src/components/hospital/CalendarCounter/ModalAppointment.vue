          ...
          <v-container fill-height>
            <v-form  lazy-validation>
              <v-layout wrap align-center>
                  ...
                  <v-card class="grey-border grey lighten-5">
                    <v-container grid-list-xl>
                      ...
                      <v-divider v-if="selectedUser == true"></v-divider>
                        <v-container grid-list-md v-if="selectedUser == true"  hide-actions class="grey-border grey lighten-5">
                ...
                <v-flex xs12 sm8 class="mt-4">
                  <v-select v-model="receiveDentistId" :placeholder="receiveDentistName" label="ระบุชื่อหมอ" readonly   >
                  </v-select>
                </v-flex>
                <v-flex xs12 sm4 class="mt-4">
                ...
                <v-flex xs12 sm4 class="pr-5 mt-4">
                  <v-text-field slot="activator" v-model="receiveDate" :placeholder="receiveDate" label="วันที่นัดหมาย" append-icon="event" readonly></v-text-field>
                </v-flex>
                <v-flex xs12 sm4 class="pl-5 mt-4">
                  <v-text-field slot="activator" v-model="receiveTimeAppoint" :placeholder="receiveTimeAppoint" label="เวลาที่นัดหมาย" append-icon="access_time" readonly></v-text-field>
                </v-flex>
                <v-flex xs12 sm4 class="mt-4">
...
export default {
  ...
  methods: {
    ...
    open (item1, dentistName, date, dentistId, timeAppoint) {
      this.popup = true
      this.receiveCalenderItems = item1
      this.receiveDentistName = dentistName
      this.receiveDate = date
      this.receiveDentistId = dentistId
      this.receiveTimeAppoint = timeAppoint
    },
    closeSearchUser () {
    ...
    addAppointmentold () {
      var textSource = {
        ...
        dateAppoint: this.receiveDate,
        timeAppoint: this.receiveTimeAppoint
      }
